...
const storyContent = {
  reading: {
    ...
    quote: ""A reader lives a thousand lives before they die. The one who never reads lives only one." — George R.R. Martin"
  },
  watching: {
    ...
    quote: ""Television is by nature the dominator drug par excellence. Control of content, uniformity of content, repeatability of content make it inevitably a tool of coercion, brainwashing, and manipulation." — Jerry Mander"
  },
  painting: {
...
export default function HobbyStory() {
  const [activeHobby, setActiveHobby] = useState<keyof typeof storyContent | null>(null)
  ...
  const openStory = (hobby: keyof typeof storyContent) => {
              ...
              <div className="grid md:grid-cols-2 h-full max-h-[80vh]">
                ...
                <div className="p-6 md:p-8 flex flex-col h-full overflow-hidden">
                  <AnimatePresence mode="wait">
                    ...
                    >
                      {activeHobby && currentPage < storyContent[activeHobby].content.length ? (
                  ...
                  <div className="flex justify-between items-center mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <span className="text-sm text-gray-500">
                      {activeHobby && `${currentPage + 1} of ${storyContent[activeHobby].content.length + 1}`}
                    </span>
                    <Button
                      variant="ghost"
                      onClick={nextPage}
                      className={currentPage >= (activeHobby ? storyContent[activeHobby].content.length : 0) ? "invisible" : ""}
                    >
                      Next
                    </Button>
                  </div>

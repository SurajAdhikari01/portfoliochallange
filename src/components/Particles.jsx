...
export default function Particles({ className, quantity = 50, isDark = false }: ParticlesProps) {
  ...
  useEffect(() => {
    ...
    const createParticle = (x: number, y: number) => {
      ...
      const animate = () => {
        ...
        if (posX < -size || posX > window.innerWidth + size || posY < -size || posY > window.innerHeight + size) {
